...
I'm a Backend-focused Software Engineer with 10+ years of experience designing, building, and scaling distributed systems for finance and retail. I work mainly with .NET and Java, building RESTful APIs and microservices, integrating databases, and automating delivery pipelines through modern DevOps practices.

I care about writing clear, maintainable code and understanding how systems behave in production. In recent years, I've woven AI coding agents (Claude, GitHub Copilot, OpenAI Codex) into my daily workflow — accelerating API scaffolding, strengthening code review, and speeding up debugging and root-cause analysis on production issues. I'm also spending more time learning about application security, Linux, and cloud infrastructure, and applying those concepts through hands-on labs and personal projects.

Outside of work, I enjoy experimenting with new tools, exploring Android development, and keeping up with tech and security topics that help me grow as an engineer.
...
- [TryHackMe](https://tryhackme.com/p/mfrl)
